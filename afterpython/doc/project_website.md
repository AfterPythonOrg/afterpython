...
Once enabled, every `ap build` will run pdoc against your package and the "API Reference" link will appear in the navbar automatically. The pages are also indexed by the site-wide search.
